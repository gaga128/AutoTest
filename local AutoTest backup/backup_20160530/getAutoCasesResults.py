...
def createcase(casepath,defaultname,resultname,Speparamlist):
	...
	try:
		...
		Execution.Executionmode(runFirstnullresult, casepath, resultname)
...
if __name__ == '__main__' :
	runFirstnullresult=createcase(os.getcwd()+r'/mycase/demo.xls','Default parameter','AutoCaRe',['','!@#$%^&*','1212321'])
	Execution.Executionmode(runFirstnullresult, os.getcwd() + r'/mycase/demo.xls','AutoCaRe')