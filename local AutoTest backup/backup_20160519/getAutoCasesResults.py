...
def createcase(casepath,defaultname,resultname,Speparamlist):
	...
	try:
		...
		if resultname in bk.sheet_names():
			...
			writeExcelresult.writeResult(runFirstnullresult,resultpath,defaultname)
...
if __name__ == '__main__' :
	...
	writeExcelresult.writeResult(runFirstnullresult,os.getcwd()+r'/mycase/demo.xls','AutoCaRe')